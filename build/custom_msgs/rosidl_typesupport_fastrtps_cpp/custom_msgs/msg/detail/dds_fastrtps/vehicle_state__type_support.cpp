...
#include "custom_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::VehicleState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::VehicleState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::VehicleState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::VehicleState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::VehicleState *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, VehicleState)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
