...
bool custom_msgs__msg__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._goal.Goal", full_classname_dest, 26) == 0);
  }
  custom_msgs__msg__Goal * ros_message = _ros_message;
  {  // target_x
...
PyObject * custom_msgs__msg__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._goal");
