...
#include "custom_msgs/msg/detail/map_data__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // esdf_array, occupancy_array
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // esdf_array, occupancy_array
...
using _MapData__ros_msg_type = custom_msgs__msg__MapData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: occupancy_array
  {
    size_t size = ros_message->occupancy_array.size;
    auto array_ptr = ros_message->occupancy_array.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: esdf_array
  {
    size_t size = ros_message->esdf_array.size;
    auto array_ptr = ros_message->esdf_array.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: occupancy_array
  {
    ...
    if (ros_message->occupancy_array.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->occupancy_array);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->occupancy_array, size)) {
      fprintf(stderr, "failed to create array for field 'occupancy_array'");
      return false;
    }
    auto array_ptr = ros_message->occupancy_array.data;
  ...
  // Field name: esdf_array
  {
    ...
    if (ros_message->esdf_array.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->esdf_array);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->esdf_array, size)) {
      fprintf(stderr, "failed to create array for field 'esdf_array'");
      return false;
    }
    auto array_ptr = ros_message->esdf_array.data;
    cdr.deserializeArray(array_ptr, size);
...
size_t get_serialized_size_custom_msgs__msg__MapData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MapData__ros_msg_type * ros_message = static_cast<const _MapData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MapData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__MapData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__MapData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__MapData;
    is_plain =
      (
...
static size_t _MapData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__MapData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, MapData)() {
