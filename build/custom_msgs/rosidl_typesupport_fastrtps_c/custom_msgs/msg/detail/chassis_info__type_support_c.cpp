...
#include "custom_msgs/msg/detail/chassis_info__rosidl_typesupport_fastrtps_c.h"
...
using _ChassisInfo__ros_msg_type = custom_msgs__msg__ChassisInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ChassisInfo__ros_msg_type * ros_message = static_cast<const _ChassisInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: trigger_relocation
  {
    cdr << (ros_message->trigger_relocation ? true : false);
  }

  // Field name: trigger_target
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ChassisInfo__ros_msg_type * ros_message = static_cast<_ChassisInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_msgs__msg__ChassisInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ChassisInfo__ros_msg_type * ros_message = static_cast<const _ChassisInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ChassisInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__ChassisInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__ChassisInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__ChassisInfo;
    is_plain =
      (
...
static size_t _ChassisInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__ChassisInfo(
...
static message_type_support_callbacks_t __callbacks_ChassisInfo = {
  "custom_msgs::msg",
  "ChassisInfo",
...
static rosidl_message_type_support_t _ChassisInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ChassisInfo,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, ChassisInfo)() {
  return &_ChassisInfo__type_support;
}
